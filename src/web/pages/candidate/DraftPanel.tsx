...
import { LintBadges, Menu, REASONS, targetLabel } from "../../components/ui";
    ...
    <div className="card draft-card">
      ...
      <div className="draft-head">
        ...
        {!editing && <div className="row" style={{ gap: 8 }}>
          <div className="seg" role="group" aria-label="보기 방식"><button aria-pressed={view === "preview"} className={view === "preview" ? "active" : ""} onClick={() => setView("preview")}>미리보기</button><button aria-pressed={view === "text"} className={view === "text" ? "active" : ""} onClick={() => setView("text")}>텍스트</button></div>
