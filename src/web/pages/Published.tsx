...
function ManualStats({ id, stats }: { id: number; stats?: { likes?: number; comments?: number; reposts?: number } }) {
  const set = (args: { id: number; likes: number; comments: number; reposts: number }) => post(`/publications/${args.id}/stats`, { likes: args.likes, comments: args.comments, reposts: args.reposts });
